...
# MARK: dict of policy name and its 
show_name_dict = {
    "sr-greedy":   "SR",
    ...
    "['sr-greedy', 'sr-replace-60', 'mp-search']": "DSScheduler",
    "['sr-greedy', 'sr-replace-21600', 'mp-search']": "DSScheduler"
...
method_order_list = [
    ...
    "['sr-greedy', 'sr-replace-60', 'mp-search']",
    "['sr-greedy', 'sr-replace-21600', 'mp-search']"
]
